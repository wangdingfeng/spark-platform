...
public class ShopSeckillController extends BaseController {
      ...
      public ApiResponse save(@RequestBody ShopSeckill shopSeckill){
        return success(shopSeckillService.save(shopSeckill));
      }

      @PutMapping
      @ApiOperation(value = "更新秒杀配置信息")
      public ApiResponse update(@RequestBody ShopSeckill shopSeckill){
        return success(shopSeckillService.updateById(shopSeckill));
      }
