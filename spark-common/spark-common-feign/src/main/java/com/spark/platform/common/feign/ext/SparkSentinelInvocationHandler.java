 ...
 * @Description: 支持自动降级注入 重写 代码参考 pig
 */
@Slf4j
public class SparkSentinelInvocationHandler implements InvocationHandler {
    ...
    SparkSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            SparkSentinelInvocationHandler other = (SparkSentinelInvocationHandler) obj;
